/**
 * This is an example of how to interact with my fuel storage
 * changed and added lines are indicated
 * 
 */
...
/*IFuelContainer*/  if (this.furnaceItemStacks[1] != null && !(this.furnaceItemStacks[1].getItem() instanceof IFuelContainer))
                    {
...
//IFuelContainer interaction start
        else if(par0ItemStack.getItem() instanceof IFuelContainer)
        {
        	...
        	if(fuelValue == 0)
        		return 0;
        	else if(fuelValue >= 1600)
        	{
        		((IFuelContainer)par0ItemStack.getItem()).setFuel(par0ItemStack, -1600, false);
        		return 1600;
        	}
        	else
        	{
...
//Extra method for checking the burn time without reducing it
     ...
     */
//Changed to check to not remove fuel from a cell
