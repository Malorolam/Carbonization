...
public class BlockFurnaces extends BlockContainer
{
    ...
    public BlockFurnaces(int par1, boolean par2)
    {
    ...
    public Icon getBlockTexture(IBlockAccess par1IBlockAccess, int x, int y, int z, int side)
    {
    	...
    	if(te==null)
    		FMLLog.log(Level.WARNING, "We have no tile entity at: " + x + " " + y + " " + z);
    ...
    public void randomDisplayTick(World par1World, int x, int y, int z, Random par5Random)
    {
        if (isActive)
        {
            ...
            {
            	FMLLog.log(Level.WARNING, "Oh noes, no tile entity for our toes!");
            }
