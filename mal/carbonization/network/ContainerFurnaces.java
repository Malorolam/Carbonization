...
public class ContainerFurnaces extends Container
{
    private TileEntityFurnaces furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerFurnaces(InventoryPlayer par1InventoryPlayer, TileEntityFurnaces par2TileEntityFurnace)
    {
    ...
    public void addCraftingToCrafters(ICrafting par1ICrafting)
    {
        ...
        par1ICrafting.sendProgressBarUpdate(this, 10, this.furnace.furnaceBurnTime);
        par1ICrafting.sendProgressBarUpdate(this, 20, this.furnace.currentItemBurnTime);
    }
