...
/*		//crafting
		...
		//fuel
		this.addSlotToContainer(new Slot(bench, 35, 134, 47));
    ...
    public void onCraftMatrixChanged(IInventory par1IInventory)
    {
    	if(populating)
    		return;
        this.craftResult.setInventorySlotContents(0, CraftingManager.getInstance().findMatchingRecipe(this.craftMatrix, bench.worldObj));
