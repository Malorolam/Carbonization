...
public class CarbonizationGenMinable extends WorldGenerator
{
    ...
    public CarbonizationGenMinable(Block block, int num)
    {
        this.minableBlock = block;
        this.numberOfBlocks = num;
    }

    public CarbonizationGenMinable(Block block, int meta, int number, int diff)
    {
        this(block, number);
        minableBlockMeta = meta;
    }
    
    public boolean generateStone(World par1World, Random par2Random, int x, int y, int z)
    {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && (block != null && block.isEqualTo(block, Blocks.stone)))
                                {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                Block block = par1World.getBlock(var38, var41, var44);
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && (block != null && Block.isEqualTo(block, Blocks.dirt)))
                                {
                                    par1World.setBlock(var38, var41, var44, this.minableBlock, minableBlockMeta, 2);
                                }
                            }
    ...
    /**
     * Use generateDirt or generateStone instead
     */
	@Override
