...
import mal.carbonization.gui.slot.multiblockFurnaceSlot;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            else if (par2 >=18)//inventory
            {
            	 ...
            	 */
                if (CarbonizationRecipeHandler.smelting().getMultiblockCookTime(var5) != -1)//has a multiblock recipe
                {
                ...
                else if (UtilReference.getItemBurnTime(var5, 1, false)>0)
                {
                    if (!this.mergeItemStack(var5, 0, 9, false))
                    {
                        return null;
