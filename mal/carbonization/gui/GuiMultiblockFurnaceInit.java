...
public class GuiMultiblockFurnaceInit extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.xbox = new GuiTextField(this.fontRendererObj, (this.width - 248) / 2 + 50, (this.height - 166) / 2 + 35, 60 , 20);
        this.xbox.setMaxStringLength(2);
        this.xbox.setFocused(true);
        this.xbox.setText(String.valueOf(this.test.xdiff));
        this.ybox = new GuiTextField(this.fontRendererObj, (this.width - 248) / 2 + 50, (this.height - 166) / 2 + 65, 60, 20);
        this.ybox.setMaxStringLength(2);
        this.ybox.setFocused(false);
        this.ybox.setText(String.valueOf(this.test.ydiff));
        this.zbox = new GuiTextField(this.fontRendererObj, (this.width - 248) / 2 + 50, (this.height - 166) / 2 + 95, 60, 20);
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.fontRendererObj.drawString("Multiblock Initilization:", k, l, 2039583);
        l += 12;
        GameSettings gamesettings = this.mc.gameSettings;
        String s = "Min. Size: 3x3x3;  Max. Size: 9x6x9";
        this.fontRendererObj.drawString(s, k, l, 5197647);
        this.fontRendererObj.drawString("X Size:", k, l+20, 2039583);
        this.fontRendererObj.drawString("Y Size:", k, l+50, 2039583);
        this.fontRendererObj.drawString("Z Size:", k, l+80, 2039583);
