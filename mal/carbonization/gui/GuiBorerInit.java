...
public class GuiBorerInit extends GuiScreen
{
    ...
    public GuiBorerInit(TileEntityMultiblockBoreInit par2TileEntityTest, EntityPlayer player)
    {
    ...
    public void initGui()
    {
        ...
        this.xbox.setText(String.valueOf(this.test.width));
        ...
        this.ybox.setText(String.valueOf(this.test.height));
    }
        ...
        switch (par1GuiButton.id)
        {
            case 1:
                ...
                try
                {
                    ...
                    this.test.closeGui(player, xdiff, ydiff, 3, true);
            ...
            case 2:
            	try
            	{
                    ...
                    this.test.closeGui(player, xdiff, ydiff, 3, false);
                    this.mc.displayGuiScreen((GuiScreen)null);
                    this.mc.setIngameFocus();
            	}
            	catch (Throwable t)
